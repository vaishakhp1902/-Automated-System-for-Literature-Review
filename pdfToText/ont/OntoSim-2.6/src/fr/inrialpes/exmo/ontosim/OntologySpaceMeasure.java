/**
 *   Copyright 2008-2011, 2015 INRIA, Université Pierre Mendès France
 *   
...
public class  OntologySpaceMeasure implements Measure<LoadedOntology<?>> {
	...
	private Set<Entity<?>> getEntities(LoadedOntology<?> o1) {
		...
		if (t instanceof ParameterizedType) {
			...
			if ( pt.getActualTypeArguments()[0] instanceof ParameterizedType && ((ParameterizedType)pt.getActualTypeArguments()[0]).getActualTypeArguments()[0] == OntResource.class) {
