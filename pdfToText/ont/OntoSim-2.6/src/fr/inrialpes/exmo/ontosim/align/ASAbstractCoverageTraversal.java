 ...
 *
 *   Copyright (C) 2009, 2011, 2017 INRIA, Universite Pierre Mendes France
 *   
 *   ASLargestCoverageMeasure.java is part of OntoSim.
 *
...
public abstract class ASAbstractCoverageTraversal extends AbstractAlignmentSpaceMeasure<LoadedOntology<?>> {
    ...
    /**
     *
     * @param al an alignment through which the entities will be transformed
     * @param entities a record of which entity has already been transformed into which entity
     * @return a hashtable containing pairs: target URI x source URI such that the alignment would transform these entities
     */
    ...
    /**
     * @param o1: an ontology 
     * @return the set of URI of objects belonging to the ontology.
     *
