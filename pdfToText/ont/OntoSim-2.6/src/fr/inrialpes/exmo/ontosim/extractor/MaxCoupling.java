...
import fr.inrialpes.exmo.ontosim.util.measures.MeasureUtility;
...
public class MaxCoupling extends AbstractExtractor {
    ...
    @Override
    public <O> Matching<O> extract(Measure<O> m, Collection<? extends O> src, Collection<? extends O> trg) {
	//this.getClass().g
	O[] s1=null;
	O[] s2=null;
	...
	double[][] values = MeasureUtility.getVals(SimilarityUtility.convert(m), s1, s2);
